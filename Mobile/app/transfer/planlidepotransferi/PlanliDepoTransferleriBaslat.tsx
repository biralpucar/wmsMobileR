...
interface PlanliDepoTransferleriBaslatProps {
  transfer: PlanliTransfer;
  selectedDepo?: string;
  onClose: () => void;
}

const PlanliDepoTransferleriBaslat: React.FC<PlanliDepoTransferleriBaslatProps> = ({
  transfer,
  selectedDepo,
  onClose
}) => {
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: backgroundColor }}>
      ...
      >
        ...
        <View style={{ padding: 16, borderWidth: 2, borderColor: blueBorderColor, borderRadius: 12 }}>
          ...
          {/* Transfer Kartı */}
          <View style={{ backgroundColor: cardColor, borderRadius: 12, borderWidth: 1, borderColor: blueBorderColor, overflow: 'hidden', marginBottom: 16 }}>
            {/* Transfer Header */}
            ...
            <View style={{ padding: 16, gap: 12 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <View style={{flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 20, backgroundColor: transfer.eIrsaliye ? greenColor : redColor}}>
                  <Ionicons
                    name={transfer.eIrsaliye ? 'checkmark' : 'close'}
                    size={14}
                    color={transfer.eIrsaliye ? textColor : textColor}
                  />
                  <Text style={{fontSize: 12, fontWeight: '500', marginLeft: 4, color: transfer.eIrsaliye ? textColor : textColor}}>
              ...
              <View style={{ gap: 8 }}>
                ...
                <View style={{ backgroundColor: borderColor, borderRadius: 8, padding: 12, gap: 4, borderWidth: 1, borderColor: purpleBorderColor }}>
                  <Text style={{ fontSize: 14, fontWeight: '600', color: textColor }}>1. {transfer.aciklama1}</Text>
                  <Text style={{ fontSize: 14, fontWeight: '600', color: textColor }}>2. {transfer.aciklama2}</Text>
                ...
                {[
                  ...
                  <View key={index} style={{ marginBottom: index === 2 ? 0 : 16 }}>
                    <View style={{ backgroundColor: index % 2 === 0 ? borderColor : indigoColor, borderRadius: 8, padding: 12, gap: 8 }}>
                      ...
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Text style={{ fontSize: 12, fontWeight: '600', color: textColor }}>{t('miktarKadarSeri')}:</Text>
                        <View style={{
                          flexDirection: 'row',
                          alignItems: 'center',
                          paddingHorizontal: 8,
          ...
          <View style={{ marginBottom: 16 }}>
            {/* <Text style={{ fontSize: 18, fontWeight: '600', color: textColor, marginBottom: 12 }}>Barkod Okutma</Text> */}
            <TouchableOpacity
              style={{
...
export default PlanliDepoTransferleriBaslat;