...
interface AmbarGirisSiparisBaglantiliForm2Props {
  formData: {
    selectedDepo?: string;
    hucreTuru?: string;
    cikisYeri?: string;
...
export default function AmbarGirisSiparisBaglantiliForm2({
  formData,
  onNext,
  onBack
}: AmbarGirisSiparisBaglantiliForm2Props) {
  // Tema hook'ları
  ...
  return (
    <View style={{ backgroundColor: cardColor, borderColor: blueBorderColor, borderWidth: 2, borderRadius: 16, padding: 24 }}>
      {/* Başlık */}
      ...
      {selectedCategoryDetails && selectedCategoryDetails.length > 0 ? (
          ...
          >
            ...
            {category.products && category.products.length > 0 ? (
                    ...
                    >
                      ...
                      {expandedProducts[productKey] && (
                        <View style={{ paddingLeft: 8 }}>
                          ...
                          {/* Ambar Giriş Miktarı Gir TextBox */}
                          <View style={{ marginBottom: 12 }}>
                            ...
                            <TextInput
                              ...
                              placeholder={t('ambarGirisMiktariniGirin')}
              ...
              <View className="bg-gray-50 rounded-lg p-6 items-center">
                ...
                <Text style={{ color: textColor, opacity: 0.7, textAlign: 'center', marginTop: 12, fontWeight: '500' }}>{t('buKategorideSeciliUrunBulunmamaktadir')}</Text>
              </View>
            )}
            </View>
          ))
        ...
        <View className="bg-white rounded-xl p-6 mb-6 shadow-sm border border-gray-200">
          <View className="flex-row items-center mb-4">
            ...
            <Text className="text-lg font-bold text-gray-900">{t('seciliSiparisler')}</Text>
          </View>
          <View className="bg-gray-50 rounded-lg p-6 items-center">
            <Ionicons name="cube-outline" size={48} color="#9CA3AF" />
            <Text style={{ color: textColor, opacity: 0.7, textAlign: 'center', marginTop: 12, fontWeight: '500' }}>{t('seciliSiparisBulunmamaktadir')}</Text>
            <Text className="text-gray-400 text-center text-sm mt-1">{t('oncekiSayfadanSiparisSecimiYapiniz')}</Text>
          </View>
        </View>
        )}
